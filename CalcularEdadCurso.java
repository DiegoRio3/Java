...
public class CalcularEdadCurso {
    public static void main(String[] args) throws ParseException {
        ...
        int edadConDecenasYCentenas = hasta - desde;
        System.out.println("La edad es: " + edad);

        //Linea agregada para saber que resultaba nada mas
        System.out.println("edadConDecenasYCentenas = " + edadConDecenasYCentenas);
    }
}
// Aquí, convertimos los objetos date fechaNacimiento y actual en números enteros que contienen el año mes y día,
// luego los restamos para obtener la diferencia entre ellos, luego se divide por 10000 para aproximar y quitar decimales: